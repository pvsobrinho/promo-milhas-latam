...
# ========= CONFIGURAÇÕES =========
NUM_ITERACOES = 90  # Pode ser alterado conforme desejado
DIRETORIO_SAIDA = "prints_milhas"
POSICAO_CLIQUE = (1747, 729)  # Altere conforme a seta na sua tela
DELAY_INICIAL = 5
DELAY_ENTRE_ITERACOES = 10
DATA_INICIAL = datetime.strptime("2025-11-08", "%Y-%m-%d")
# =================================
...
# Exibe top 3 menores valores
top_3 = heapq.nsmallest(3, milhas_extraidas, key=lambda x: x[0])
print("\n🏆 Top 3 menores valores encontrados:")
for milhas, data in top_3:
